...
## Corpus Check
- 141 files · ~631,056 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1441 nodes · 3437 edges · 79 communities (68 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6e1c059f`
...
Cohesion: 0.08
Nodes (25): log, ToolHandler, ToolResult, SessionToolCall, TRIAGE_VERDICTS, AgentSettableStage, agentSettableStageSchema, askUserArgsSchema (+17 more)
...
Cohesion: 0.11
Nodes (12): active, ensureNotificationPermission(), isSupported(), playNotificationSound(), showDesktopNotification(), BoardState, BoardStore, CommentListener (+4 more)
...
Cohesion: 0.09
Nodes (20): resolveBaseBranch(), log, ReclaimOutcome, SETUP_PHASES, SlotManagerConfig, log, SlotWatch, WorktreeAddressWatcher (+12 more)
...
Cohesion: 0.09
Nodes (21): BASH_ALLOWLIST, buildImplementSessionConfig(), implementerAgent(), ImplementSessionInput, prFixerAgent(), LiveSession, log, previewToolInput() (+13 more)
...
Cohesion: 0.13
Nodes (13): log, createLogger(), log, dryRunLog, FAKE_OPEN_PRS, fakeEncoder, hexToBytes(), GitWorktreeAddOptions (+5 more)
...
Cohesion: 0.20
Nodes (13): bashCommandSchema, buildSettings(), claudeProvider, createSdkAgentSession(), dispatch(), HIDDEN_COMMIT_ATTRIBUTION, pumpStream(), SDK_EFFORTS (+5 more)
...
## Knowledge Gaps
- **376 isolated node(s):** `SDK_EFFORTS`, `bashCommandSchema`, `SdkEffort`, `SdkAgents`, `HIDDEN_COMMIT_ATTRIBUTION` (+371 more)
...
- **Why does `Ticket` connect `Worker Hub & Bridge` to `Slot & Project Config`, `Agents & Ticket UI`, `API Schemas & Inputs`, `Store & Profiles`, `Feasibility Batch Manager`, `API Routes & Schemas`, `Ticket Detail & Forms`, `Board Store & Notifications`, `DB Rows & Mapping`, `Client Hub & Watchdog`, `Pricing & Token Cost`, `Desktop Bootstrap`, `Board Columns`, `Ticket Lifecycle`, `Agent Config Constants`, `System Adapter Types`, `Coordinator & Hub Wiring`, `Community 46`, `Package Manifest`, `Community 60`, `Community 73`, `Community 82`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `Store` connect `Store & Profiles` to `Agent Config Constants`, `Server Entry & Static`, `Worker Hub & Bridge`, `Terminal Session Manager`, `Worker Protocol Schemas`, `Community 77`, `Feasibility Batch Manager`, `Agent Knobs & Models`, `API Routes & Schemas`, `Community 79`, `DB Rows & Mapping`, `Client Hub & Watchdog`, `Desktop Bootstrap`, `Package Manifest`, `Board Columns`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `RealSystemAdapter` connect `Review Done Gate (E2E)` to `Runtime Dependencies`, `System Adapter Types`, `Terminal Session Manager`, `Community 43`, `Agent Knobs & Models`, `Real Worktree Shell Ops`?**

...
CREATE TABLE IF NOT EXISTS tickets (
  ...
  human_tone INTEGER NOT NULL DEFAULT 0,
...
const TICKET_MIGRATIONS: { column: string; ddl: string }[] = [
  ...
  { column: "review_language", ddl: "ALTER TABLE tickets ADD COLUMN review_language TEXT" },
  { column: "human_tone", ddl: "ALTER TABLE tickets ADD COLUMN human_tone INTEGER NOT NULL DEFAULT 0" },

...
## Corpus Check
- 149 files · ~638,184 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1501 nodes · 3495 edges · 84 communities (70 shown, 14 thin omitted)
...
Cohesion: 0.05
Nodes (39): isNotionUrl(), NOTION_HOSTS, appSettingsSchema, baseBranchSchema, capabilitiesSchema, commentAuthorSchema, commentSchema, CreateTerminalBody (+31 more)
...
Cohesion: 0.08
Nodes (25): SettingsModal(), NAV_ENTRIES, NavEntry, Sidebar(), SidebarProps, SidebarView, SlotsBar(), Stat() (+17 more)
...
Cohesion: 0.10
Nodes (21): resolveBaseBranch(), log, runFirstBootSetup(), applyAppSettingsToModels(), initProjectRegistry(), listProjectKeys(), PROJECT_ROOT, _projectConfigSchema (+13 more)

### Community 18 - "Live Terminal Views"
Cohesion: 0.11
Nodes (31): AgentsViewProps, AskPanelProps, CleanPrPanel(), CleanPrPanelProps, ImportTicketsPanel(), ImportTicketsPanelProps, NewTicketDialogProps, Tab (+23 more)

### Community 19 - "Stage Progress & Display"
Cohesion: 0.16
Nodes (21): AgentCard(), AgentCardProps, AgentsView(), normalize(), TicketBadges(), projectBadgeStyle(), resolveProjectColor(), resolveProjectLabel() (+13 more)
...
Cohesion: 0.07
Nodes (29): buildScripts(), CommentRow, commentRowSchema, mapProjectRow(), mapTicketRow(), parseSessionUsage(), parseWorktreePorts(), ProfileRow (+21 more)
...
Cohesion: 0.11
Nodes (33): AgentProfileConfigProps, ImplementationAgentFieldsProps, NewAsk, NewClean, NewProfile, NewProject, NewReview, NewTicket (+25 more)
...
Cohesion: 0.13
Nodes (18): PROGRESS_BAR_COLORS, StageProgressBar(), StageProgressBarProps, ANIMATED_STAGES, BadgeVariant, DATETIME_FORMAT, NON_DEPENDABLE_COLUMNS, prNumberFromUrl() (+10 more)
...
Cohesion: 0.11
Nodes (17): labelWithDefault(), TicketConfigSummary(), CsvParseError, ParsedTicketRow, ParsedTicketsCsv, parseTicketsCsv(), AGENT_EFFORT_LABELS, AGENT_MODEL_LABELS (+9 more)
...
Cohesion: 0.15
Nodes (16): NewTicketDialog(), PrdReviewDialog(), AUTHOR_BADGES, CommentRow(), CommentRowProps, isLocked(), TicketDetail(), TriageSection() (+8 more)
...
Cohesion: 0.08
Nodes (28): DragHandleAttributes, DragHandleListeners, GeneralSettings(), IMPLEMENTER_OPTIONS, LANGUAGE_OPTIONS, ProfileRowProps, ProfilesSettings(), SettingsModalProps (+20 more)
...
Cohesion: 0.20
Nodes (5): log, createLogger(), log, UserTerminalManager, TerminalDescriptor
...
Cohesion: 0.24
Nodes (4): log, SlotWatch, WorktreeAddressWatcher, SLOTS_ROOT
...
Cohesion: 0.10
Nodes (27): AgentSessionHandle, AgentSessionOptions, dryRunLog, FAKE_OPEN_PRS, fakeEncoder, CLAUDE_JSON_PATH, COMPOSER_BINARIES, ghPrSchema (+19 more)
...
Cohesion: 0.29
Nodes (5): currentNow, startTicking(), subscribe(), subscribers, useTickTimer()
...
## Knowledge Gaps
- **382 isolated node(s):** `log`, `PROJECT_ROOT`, `_projectConfigSchema`, `SlotStatus`, `NewProject` (+377 more)
...
- **Why does `Store` connect `Database Store Operations` to `User Terminal & Fake IO`, `Desktop Bootstrap & Menus`, `Feasibility Batch Management`, `Community 67`, `Ticket Action Panels`, `Coordinator & Protocol`, `Community 46`, `API Routes & Reformulate`, `Triage & Server Hub`, `Stats Hooks & Cards`, `Community 51`, `Tick Timer Hook`, `User Terminal Manager`, `Store Types & Agent Knobs`, `Community 85`, `Workflow View & Lifecycle`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `Ticket` connect `Ticket Action Panels` to `Contract Building & Slots`, `Shared Zod Schemas`, `PR Selection & Slots Bar`, `Database Store Operations`, `API Routes & Reformulate`, `Triage & Server Hub`, `Live Terminal Views`, `Stage Progress & Display`, `Store Types & Agent Knobs`, `DB Row Schemas & Mappers`, `Client Hub & Watchdog`, `Cost & Pricing`, `Workflow View & Lifecycle`, `Agents View & Ticket Cards`, `PRD Review & Markdown`, `User Terminal & Fake IO`, `Board Columns`, `Agent Profile Config`, `Agent Coordinator Handlers`, `API Client Inputs`, `Ticket Detail & Triage UI`, `Community 46`, `Stats Hooks & Cards`, `Community 51`, `User Terminal Manager`, `Community 54`, `Community 63`, `Community 89`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `RealSystemAdapter` connect `Real System Adapter` to `Desktop Bootstrap & Menus`, `Claude SDK Provider`, `Slot Config & Worktree Watch`, `Community 61`, `Badge Component`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **What connects `log`, `PROJECT_ROOT`, `_projectConfigSchema` to the rest of the system?**

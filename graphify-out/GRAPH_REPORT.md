...
## Corpus Check
- 144 files · ~105,614 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1467 nodes · 3445 edges · 78 communities (68 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ff41c852`
...
Cohesion: 0.06
Nodes (47): AgentCard(), AgentCardProps, AgentsView(), AgentsViewProps, normalize(), PrSelectRow(), PrSelectRowProps, PROGRESS_BAR_COLORS (+39 more)
...
Cohesion: 0.05
Nodes (47): AnalyzeTicketsInput, appSettingsSchema, baseBranchSchema, capabilitiesSchema, Comment, commentAuthorSchema, commentSchema, CreateAskInput (+39 more)
...
Cohesion: 0.07
Nodes (9): detectInstallCommand(), realpathSafe(), RealSystemAdapter, resolveWorktreeScriptCommand(), shQuote(), SpawnFeasibilityOptions, SpawnTmuxOptions, SpawnTriageOptions (+1 more)
...
Cohesion: 0.12
Nodes (14): createLogger(), dataMessage(), log, normalizeSeed(), safeParse(), send(), TerminalSession, TerminalSessionManager (+6 more)

### Community 9 - "Store & Profiles"
Cohesion: 0.10
Nodes (5): SqlUpdateBuilder, Store, AppSettings, Profile, UpdateAppSettingsInput
...
Cohesion: 0.07
Nodes (21): CLAUDE_JSON_PATH, COMPOSER_BINARIES, extractPrUrl(), FEASIBILITY_DENIED_AGENTS, FEASIBILITY_SCOUT_AGENTS_JSON, FEASIBILITY_SETTINGS_JSON, ghPrSchema, ghPrStateSchema (+13 more)
...
Cohesion: 0.07
Nodes (29): CommentRow, commentRowSchema, mapProfileRow(), mapTicketRow(), parseSessionUsage(), ProfileRow, profileRowSchema, projectSchema (+21 more)
...
Cohesion: 0.05
Nodes (43): createDatabase(), migrate(), PROFILE_MIGRATIONS, seedProfiles(), seedSlots(), TICKET_MIGRATIONS, applyDesktopEnv(), DesktopRoots (+35 more)

### Community 27 - "Worker Hub & Bridge"
Cohesion: 0.09
Nodes (15): WorkerHubHandlers, WorkerSocket, WorkerSocketData, ChannelEvent, isWorkerToolName(), WORKER_TOOLS, workerInboundSchema, WorkerOutbound (+7 more)
...
Cohesion: 0.14
Nodes (11): BoardColumn(), BoardColumnProps, DEFAULT_COLLAPSED, resolveAnalyzeAllTitle(), resolveCheckAllTitle(), resolveMoveAllTitle(), SortDir, useWindowedTickets() (+3 more)
...
Cohesion: 0.19
Nodes (14): mapCommentRow(), NewClean, NewReview, SlotStatus, SqlBindValue, TicketPatch, ProjectKey, Column (+6 more)

### Community 35 - "Agent Config Constants"
Cohesion: 0.15
Nodes (7): TicketCardProps, TicketDetailProps, COLUMN_NODE_COLOR, WorkflowViewProps, TicketLifecycle, Stage, Ticket
...
Cohesion: 0.08
Nodes (34): AgentProfileConfig(), AskPanel(), ImplementationAgentFields(), DragHandleAttributes, DragHandleListeners, GeneralSettings(), IMPLEMENTER_OPTIONS, LANGUAGE_OPTIONS (+26 more)
...
Cohesion: 0.11
Nodes (9): dryRunLog, FAKE_OPEN_PRS, fakeEncoder, FakePaneStream, fakeShellPrompt(), hexToBytes(), PaneSize, ReformulateOptions (+1 more)
...
Cohesion: 0.15
Nodes (13): labelWithDefault(), TicketConfigSummary(), AGENT_EFFORT_LABELS, AGENT_MODEL_LABELS, COLUMN_LABELS, COLUMN_SORT_FIELD, COMMENT_AUTHORS, IMPLEMENTER_LABELS (+5 more)
...
Cohesion: 0.15
Nodes (7): RouteDeps, log, UserTerminalManager, TerminalDescriptor, GitWorktreeAddOptions, PrepareSlotFiles, SystemAdapter
...
- **Why does `Ticket` connect `Agent Config Constants` to `Slot & Project Config`, `Agents & Ticket UI`, `API Schemas & Inputs`, `Store & Profiles`, `Agent Profile & Ask Panel`, `API Routes & Schemas`, `Board Store & Notifications`, `DB Rows & Mapping`, `Client Hub & Watchdog`, `Pricing & Token Cost`, `App & Board Root`, `Ticket Lifecycle`, `Ticket Store Types`, `Runtime Dependencies`, `Triage Manager`, `Agent Knobs & Models`, `Triage Verdicts & Config`, `Community 73`, `Community 78`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `Store` connect `Store & Profiles` to `Ticket Store Types`, `Agent Config Constants`, `API Schemas & Inputs`, `Terminal Session Manager`, `Triage Manager`, `Agent Profile & Ask Panel`, `Worker Protocol Schemas`, `Agent Knobs & Models`, `Feasibility Batch Manager`, `Community 78`, `API Routes & Schemas`, `CONTEXT.md Glossary`, `Client Hub & Watchdog`, `Community 86`, `Desktop Bootstrap`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `FakeSystemAdapter` connect `Fake System Adapter` to `Community 86`, `System Adapter Types`?**

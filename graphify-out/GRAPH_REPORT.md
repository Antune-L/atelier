...
## Corpus Check
- 140 files · ~631,306 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1432 nodes · 3446 edges · 77 communities (69 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `06f2bc1f`
...
Cohesion: 0.10
Nodes (23): resolveBaseBranch(), Composer 2.5 Implementer Path, buildAskContract(), buildCleanContract(), buildConflictResolutionContract(), buildFeasibilityContextSection(), buildImplementingSteps(), buildPlanningStep() (+15 more)

### Community 1 - "Agents & Ticket UI"
Cohesion: 0.13
Nodes (15): labelWithDefault(), TicketConfigSummary(), AGENT_EFFORT_LABELS, AGENT_MODEL_LABELS, AGENT_MODELS, COMMENT_AUTHORS, FAILURE_COLUMNS, IMPLEMENTER_LABELS (+7 more)
...
Cohesion: 0.05
Nodes (37): appSettingsSchema, baseBranchSchema, capabilitiesSchema, commentAuthorSchema, commentSchema, CreateTerminalBody, EXTERNAL_URL_PROTOCOLS, externalUrlSchema (+29 more)
...
Cohesion: 0.11
Nodes (17): TRIAGE_VERDICTS, AgentSettableStage, agentSettableStageSchema, askUserArgsSchema, AssertNamesCovered, channelEventSchema, doneArgsSchema, failArgsSchema (+9 more)
...
Cohesion: 0.13
Nodes (30): AgentsViewProps, AskPanelProps, CleanPrPanel(), CleanPrPanelProps, NewTicketDialogProps, Tab, TAB_TITLES, TabButtonProps (+22 more)

### Community 19 - "Board Store & Notifications"
Cohesion: 0.15
Nodes (16): AnnotatedHtml, isInsideAnnotation(), PrdAnnotation, PrdReviewDialog(), PrdReviewDialogProps, SelectionState, wrapFirstOccurrence(), QuitConfirmModal() (+8 more)
...
Cohesion: 0.13
Nodes (8): active, ensureNotificationPermission(), isSupported(), playNotificationSound(), showDesktopNotification(), BoardStore, Listener, WsClientEvent
...
Cohesion: 0.09
Nodes (21): log, ReclaimOutcome, SETUP_PHASES, SlotManagerConfig, log, SlotWatch, WorktreeAddressWatcher, log (+13 more)
...
Cohesion: 0.17
Nodes (5): addUsageByModel(), AgentCoordinator, toUsageByModel(), SessionToolCall, WorkerToolName
...
Cohesion: 0.17
Nodes (3): mapCommentRow(), SqlUpdateBuilder, CommentAuthor

### Community 37 - "Settings Modal"
Cohesion: 0.07
Nodes (33): DragHandleAttributes, DragHandleListeners, GeneralSettings(), IMPLEMENTER_OPTIONS, LANGUAGE_OPTIONS, ProfileRowProps, ProfilesSettings(), SettingsModal() (+25 more)
...
Cohesion: 0.08
Nodes (39): AgentCard(), AgentCardProps, AgentsView(), normalize(), PROGRESS_BAR_COLORS, StageProgressBar(), StageProgressBarProps, TicketBadges() (+31 more)
...
Cohesion: 0.20
Nodes (9): log, ToolHandler, ToolResult, log, ClientSocket, ClientSocketData, NativeNotify, ACTIVE_STAGES (+1 more)
...
Cohesion: 0.12
Nodes (9): AgentSessionOptions, dryRunLog, FAKE_OPEN_PRS, fakeEncoder, FakePaneStream, hexToBytes(), GitWorktreeAddOptions, PaneSize (+1 more)
...
Cohesion: 0.12
Nodes (22): AgentProfileConfig(), AskPanel(), ImplementationAgentFields(), SlotsBar(), Stat(), StatProps, STATUS_LABELS, TerminalsView() (+14 more)

### Community 49 - "Database Schema & Seed"
Cohesion: 0.50
Nodes (8): buildContractConstraintsLines(), buildResponseFormatLines(), buildStrictRulesLines(), buildTicketLines(), buildTriageChannelPrompt(), buildTriagePlusChannelPrompt(), isEnglish(), CommitLanguage
...
Cohesion: 0.12
Nodes (20): WORKER_TOOLS, resolveClaudeBinary(), bashCommandSchema, buildSettings(), claudeProvider, consumeOneShot(), createSdkAgentSession(), dispatch() (+12 more)
...
Cohesion: 0.10
Nodes (5): SessionHub, Watchdog, ClientHub, Notifier, SystemAdapter

### Community 60 - "Community 60"
Cohesion: 0.15
Nodes (14): Board(), BoardProps, normalize(), Toaster(), WorkflowView(), WorktreeSessionsView(), WorktreeSessionsViewProps, useBoard() (+6 more)
...
Cohesion: 0.15
Nodes (18): NewTicketDialog(), resolveProjectColor(), resolveProjectLabel(), AUTHOR_BADGES, CommentRow(), CommentRowProps, isLocked(), TicketDetail() (+10 more)

## Knowledge Gaps
- **380 isolated node(s):** `ONE_SHOT_ALLOWED_TOOLS`, `SDK_EFFORTS`, `bashCommandSchema`, `SdkEffort`, `SdkAgents` (+375 more)
...
- **Why does `Ticket` connect `Worker Hub & Bridge` to `Slot & Project Config`, `Agents & Ticket UI`, `API Schemas & Inputs`, `Store & Profiles`, `Agent Profile & Ask Panel`, `API Routes & Schemas`, `Ticket Detail & Forms`, `DB Rows & Mapping`, `Client Hub & Watchdog`, `Build Scripts`, `Pricing & Token Cost`, `Desktop Bootstrap`, `Board Columns`, `Ticket Lifecycle`, `Runtime Dependencies`, `Coordinator & Hub Wiring`, `Community 42`, `User Terminal Manager`, `Database Schema & Seed`, `Package Manifest`, `Community 60`, `Community 84`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `Store` connect `Store & Profiles` to `Ticket Store Types`, `Runtime Dependencies`, `Terminal Session Manager`, `Community 42`, `Agent Profile & Ask Panel`, `Community 77`, `Feasibility Batch Manager`, `Triage Prompt Builder`, `API Routes & Schemas`, `Community 50`, `Community 79`, `Community 52`, `Desktop Bootstrap`, `Package Manifest`, `Board Columns`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `RealSystemAdapter` connect `Review Done Gate (E2E)` to `Ticket Store Types`, `System Adapter Types`, `Terminal Session Manager`, `Community 43`, `Agent Knobs & Models`, `Real Worktree Shell Ops`, `Community 56`, `Package Manifest`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **What connects `ONE_SHOT_ALLOWED_TOOLS`, `SDK_EFFORTS`, `bashCommandSchema` to the rest of the system?**
